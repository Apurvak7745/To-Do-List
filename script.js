...
const deletListButton = document.querySelector('[data-delet-list-botton]')
const listDisplayContaier = document.querySelector('[data-list-display-container]')
...
deletListButton.addEventListener('click', e => {
...
function render() {
  ...
  if (selectedListId == null) {
    listDisplayContaier.style.display = 'none'
  } else {
    listDisplayContaier.style.display = ''
